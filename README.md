...
To change locale settings, please edit 27 and 28 lines in `script` file accordingly. The default ones are set to English (United States). For all the available options, see `locale-settings-manual` file available [here](https://github.com/barteqcz/albi/blob/main/docs/locale-settings-help)
